(function () {
  ...
  var Layout = {
    ...
    view: function view(vnode) {
      return mithril("#menubar", mithril("ul.nav.justify-content-center", [mithril("li.nav-item", mithril("a.nav-link[href='/list']", {
        oncreate: mithril.route.link
      }, "Users")), mithril("li.nav-item", mithril("a.nav-link.active[href='/login']", {
        onclick: vnode.logout
      }, "LogOut"))]), mithril("div.container", [mithril(".vspace"), mithril(".err"), mithril("section", vnode.children)]));
    }
  };
  ...
  var Login = {
    ...
    view: function view(vnode) {
      return mithril("div.container", [mithril(".vspace"), mithril(".err"), mithril("#signin", mithril(".card.card-body.w-75", mithril("form", [mithril(".form-group", [mithril("label[for='email']", "Email address"), mithril("input#email.form-control[name='email'][aria-describedby='emailHelp'][placeholder='Enter email'][type='email']"), mithril("small#emailHelp.form-text.text-muted", "We'll never share your email with anyone else.")]), mithril(".form-group", [mithril("label[for='password']", "Password"), mithril("input#password.form-control[name='password'][placeholder='Password'][type='password']")]), mithril("br"), mithril("button.btn.btn-primary[type='submit']", {
  ...
  function del(e) {
    ...
    if (confirm("Are you sure?")) {
      ...
      var id = url.pathname.replace("/delete/", "");
      var token = localStorage.getItem("__token");
      mithril.request({
        method: "DELETE",
        url: config.baseURL + "/api/v1/users/" + id,
  ...
  var UserList = {
    ...
    view: function view() {
      return mithril("div", [mithril("div", mithril("a.btn.btn-secondary", {
        href: "/newuser/",
        oncreate: mithril.route.link
      }, "New user")), mithril("br"), mithril("table.table", [mithril("thead", mithril("tr", [mithril("th[scope='col']", "ID"), mithril("th[scope='col']", "First name"), mithril("th[scope='col']", "Last name"), mithril("th[scope='col']", "Actions"), mithril("th[scope='col']", ""), mithril("th[scope='col']", "")])), mithril("tbody", User.list.map(function (user) {
        return mithril("tr", [mithril("td", user.id), mithril("td", user.first_name), mithril("td", user.last_name), mithril("td", mithril("a", {
          href: "/edit/" + user.id,
          oncreate: mithril.route.link
        }, "Edit")), mithril("td", mithril("a", {
          href: "/changepassword/" + user.id,
          oncreate: mithril.route.link
        }, "Change password")), mithril("td", mithril("a", {
          href: "/delete/" + user.id,
          onclick: del
        }, "Delete"))]);
      }))])]);
  ...
  var UserForm = {
    oninit: function oninit() {
      User.load(mithril.route.param("id"));
    },
    view: function view() {
      return mithril("form", {
      ...
      }, [mithril(".form-group", [mithril("label[for='userid']", "ID"), mithril("input#userid.form-control[name='userid'][disabled='disabled'][type='text']", {
        value: User.current.id
      })]), mithril(".form-group", [mithril("label[for='email']", "Email address"), mithril("input#email.form-control[name='email'][disabled='disabled'][type='email']", {
        value: User.current.email
      })]), mithril(".form-group", [mithril("label[for='firstName']", "First name"), mithril("input#firstName.form-control[name='firstName'][placeholder='First name'][type='text']", {
        oninput: mithril.withAttr("value", function (value) {
          User.current.first_name = value;
        }),
        value: User.current.first_name
      })]), mithril(".form-group", [mithril("label[for='lastName']", "Last name"), mithril("input#lastName.form-control[name='lastName'][placeholder='Last name'][type='text']", {
        oninput: mithril.withAttr("value", function (value) {
          User.current.last_name = value;
        }),
        value: User.current.last_name
      })]), mithril(".form-group", [mithril("label[for='role']", "Role"), mithril("select#role.form-control[name='role']", {
        onclick: mithril.withAttr("value", function (value) {
          User.current.role = value;
        }),
        value: User.current.role
      }, [mithril("option", "none"), mithril("option", "admin"), mithril("option", "developer"), mithril("option", "editor")])]), mithril(".form-check", [mithril("input#active.form-check-input[name='active'][type='checkbox']", {
        onclick: mithril.withAttr("checked", function (value) {
          User.current.active = value;
        }),
        checked: User.current.active
      }), mithril("label.form-check-label[for='active']", "Active")]), mithril("br"), mithril("button.btn.btn-primary[type='submit']", "Save")]);
    }
  };
  ...
  var ChangePassword = {
    ...
    view: function view(vnode) {
      return mithril("form", [mithril("input#userid[name='userid'][type='hidden']", {
        value: mithril.route.param("id")
      }), mithril(".form-group", [mithril("label[for='oldpassword']", "Old password"), mithril("input#oldpassword.form-control[name='oldpassword'][placeholder='Old password'][type='password']")]), mithril(".form-group", [mithril("label[for='newpassword']", "New password"), mithril("input#newpassword.form-control[name='newpassword'][placeholder='New password'][type='password']")]), mithril(".form-group", [mithril("label[for='repeatpassword']", "Repeat password"), mithril("input#repeatpassword.form-control[name='repeatpassword'][placeholder='Repeat password'][type='password']")]), mithril("br"), mithril("button.btn.btn-primary[type='submit']", {
        onclick: vnode.submit
      }, "Submit")]);
    }
  };
  ...
  var NewUserForm = {
    ...
    view: function view(vnode) {
      return mithril("form", [mithril(".form-group", [mithril("label[for='email']", "Email address"), mithril("input#email.form-control[name='email'][placeholder='Email address'][type='email']")]), mithril(".form-group", [mithril("label[for='password']", "Password"), mithril("input#password.form-control[name='password'][placeholder='Password'][type='password']")]), mithril(".form-group", [mithril("label[for='repeatpassword']", "Repeat password"), mithril("input#repeatpassword.form-control[name='repeatpassword'][placeholder='Repeat password'][type='password']")]), mithril(".form-group", [mithril("label[for='firstName']", "First name"), mithril("input#firstName.form-control[name='firstName'][placeholder='First name'][type='text']")]), mithril(".form-group", [mithril("label[for='lastName']", "Last name"), mithril("input#lastName.form-control[name='lastName'][placeholder='Last name'][type='text']")]), mithril(".form-group", [mithril("label[for='picture']", "Picture"), mithril("input#picture.form-control[name='picture'][disabled='disabled'][type='text']", {
        value: "unknown.png"
      })]), mithril(".form-group", [mithril("label[for='role']", "Role"), mithril("select#role.form-control[name='role']", [mithril("option", "none"), mithril("option", "admin"), mithril("option", "developer"), mithril("option", "editor")])]), mithril(".form-check", [mithril("input#active.form-check-input[name='active'][type='checkbox']"), mithril("label.form-check-label[for='active']", "Active")]), mithril("br"), mithril("button.btn.btn-primary[type='submit']", {
        onclick: vnode.submit
      }, "Save")]);
    }
  };
  ...
  mithril.route(document.body, "/login", {
    "/login": {
      render: function render() {
        return mithril(Login);
      }
    },
    "/list": {
      render: function render() {
        return mithril(Layout, mithril(UserList));
      }
    },
    "/edit/:id": {
      render: function render() {
        return mithril(Layout, mithril(UserForm));
      }
    },
    "/newuser/": {
      render: function render() {
        return mithril(Layout, mithril(NewUserForm));
      }
    },
    "/changepassword/:id": {
      render: function render() {
        return mithril(Layout, mithril(ChangePassword));
      }
    }
  });
